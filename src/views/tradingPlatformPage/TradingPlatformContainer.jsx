...
let currentPL = 0;
let fundBalance = 132025.21; //To Do replace this logic with dynamic data
class TradingPlatformContainer extends Component {
  ...
  modifyOrder = (e, instrumentId, orderId, orderType, limitPrice, index) => {
    ...
    if (isValidPrice) {
      ...
      modifiedOrderObj[instrumentId][orderId][modifiedPriceType] =
        modifiedValue;
      if (
  ...
  saveModifiedOrder(index, instrumentId, orderId) {
    ...
    if (isValidModification && orderObj[instrumentId]) {
      let { limitPrice, stopLossPrice, targetPrice } =
